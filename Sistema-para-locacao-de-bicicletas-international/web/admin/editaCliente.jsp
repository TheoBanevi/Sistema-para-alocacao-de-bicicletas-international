    ...
    <body>
        <sec:authorize access="hasRole('ADMIN')">
            ...
            <fieldset>
                ...
                <!-- Form Name -->
                <legend><f:message key="edit.client.form.legend"/></legend>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <button id="submit" type="submit" name="submit" class="btn btn-primary"><f:message key="edit.client.save.label"/></button>
                    </div>
                </div>

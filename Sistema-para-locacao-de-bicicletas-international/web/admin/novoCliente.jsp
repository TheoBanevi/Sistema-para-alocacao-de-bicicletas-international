    ...
    <body>
        <sec:authorize access="hasRole('ADMIN')">
            ...
            <fieldset>
                ...
                <!-- Form Name -->
                <c:if test="${cliente.nome == null}"> <legend><f:message key="new.client.form.legend"/></legend> </c:if>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <button id="submit" type="submit" name="submit" class="btn btn-primary"><f:message key="new.client.save.label"/></button>
                    </div>
                </div>
